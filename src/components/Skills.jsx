            ...
            <main id='skills' className='py-6 px-4 sm:p-6 md:py-10 md:px-8'>
                <div className='max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2'>
                    ...
                    <div data-aos='fade-up' data-aos-delay='600' className='mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 text-blue-950 lg:col-span-1'>
                        I’m a passionate Full Stack Developer focused on creating scalable, intelligent web applications. With experience in React, Flask, and Machine Learning, I love turning innovative ideas into functional and efficient solutions.
                    </div>
                </div>
