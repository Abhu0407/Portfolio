                ...
                <div className='container mx-auto flex px-5 py-24 items-center justify-center flex-col'>
                    <div data-aos='fade-up' data-aos-delay='300' className='text-center lg:w-2/3 w-full'>
                        ...
                        <p className='mb-8 leading-relaxed'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente enim beatae, voluptas vero quaerat consectetur molestias perferendis praesentium soluta aut. Quisquam, cumque ut officia sapiente vitae veniam qui corporis nam?
                        </p>
